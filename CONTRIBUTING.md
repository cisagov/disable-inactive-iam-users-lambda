...
issue](https://github.com/cisagov/disable-inactive-iam-users-lambda/issues) in this
...
```console
cd disable-inactive-iam-users-lambda
pyenv virtualenv <python_version_to_use> disable-inactive-iam-users-lambda
pyenv local disable-inactive-iam-users-lambda
